/**
 * Patient Registration MB Service
 * Business logic for patient registration (MB - Mikrobiologi)
 */

const { getDbConnection, closeDbConnection } = require('../../../../config/database');
const patientRepository = require('../repositories/patient-mb.repository');
