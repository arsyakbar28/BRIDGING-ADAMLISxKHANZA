...
const server = app.listen(PORT, () => {
    ...
    console.log(`      GET  /adam-lis/bridging/mb/lab-results/:limit/:noorder`);
    console.log(`      POST /adam-lis/bridging/mb`);
    console.log(``);
    console.log(`   🔬 PA (Patologi Anatomi) - Protected (requires token):`);
    console.log(`      GET  /adam-lis/bridging/pa/:limit/:noorder`);
    console.log(`      GET  /adam-lis/bridging/pa/lab-results/:limit/:noorder`);
    console.log(`      POST /adam-lis/bridging/pa`);
